...
app.initializers.add('maosal-webpush', () => {
    ...
    //    label: app.translator.trans('maosal-webpush.forum.webpush'),
    //  });
    //});
    ...
    extend(SettingsPage.prototype, 'notificationsItems', function(items) {
        items.add('webPushNotifications',
            Switch.component({
                children: app.translator.trans('maosal-webpush.forum.subscribe'),
    ...
    $(document).ready(function() {
        var OneSignal = window.OneSignal || [],
            appId = app.forum.attribute('maosal_webpush.app_id'),
            subDomain = app.forum.attribute('maosal_webpush.subdomain');
        ...
        if (typeof app.session.user != 'undefined') {
            OneSignal.push(['getNotificationPermission', function(permission) {
                if (permission == 'default' && app.forum.attribute('maosal_webpush.autoprompt')) {
                    subscribeWebPush();
                }
            }]);
            OneSignal.push(function() {
